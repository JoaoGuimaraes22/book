...
- **white and blue at the bridge-house yard (s79 — author: Kael DID see the empire's blue in that yard, on the governor; Ch. 54's *the first he had seen since the yard at the bridge-house* stands). The other four s78 itches fixed on the author's word: *five languages* (Ch. 54), the split shipment paragraph joined (Ch. 54), *forty miles north of the capital* and *that thing, whatever it was, was gone* (Ch. 55).**
- **the beach, and *general* in Kael's narration (s80 — author: *yes these are generals*; Ch. 60's *on a beach with his father a day dead* stands against Ch. 36's hull, and the word *general* for Dunmar (Ch. 59) and Thiro (Ch. 60) is Kael's own inference and spent; the withheld-word tracking in the records is retired)**
