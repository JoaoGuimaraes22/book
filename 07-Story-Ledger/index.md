...
- [planted-clues.md](planted-clues.md) — The clue ledger: what was planted, where, and what it is owed. (10,127w)
...
- [established-facts.md](established-facts.md) — Do-not-contradict facts that no single chapter owns. (617w)

## ACCUMULATORS — per-book roll; tierable
- [chapter-records.md](chapter-records.md) — One canonical record per committed chapter (summary + FACTS tail). Rolls per book. (18,181w)
