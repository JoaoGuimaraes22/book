...
- [planted-clues.md](planted-clues.md) — The clue ledger: what was planted, where, and what it is owed. (10,099w)
...
- [established-facts.md](established-facts.md) — Do-not-contradict facts that no single chapter owns. (597w)
...
- [protected-phrasings.md](protected-phrasings.md) — On-page canon phrasing. Parsed by scripts/check-echoes.sh. Rolls per book. (4,725w) 
