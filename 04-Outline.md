...
- **4 — THE CREW (the main line). SPENT INTO ITS RUNNING STATE** (Ch. 48 first contact · Ch. 49 the trade · Ch. 51 the parting · Ch. 52 the joining · Ch. 53 the first day). **What the beat still owes:** thirteen months of passage paid in work, with **three identities held the whole way** — from the crew and from everybody else; the jobs, none of them yet on the page, and **the first job is not the one Kael brings them**; and the road itself, which no page has shown beyond *upstream, then off the road*. The crew's page-state is `02-World-Bible/factions.md` §THE HONEST MEN and `03-Character-Bible/crew.md`.
