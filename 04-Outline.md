...
- **The two months east.** — SPENT: Ch. 40 "The Hands" (sixty-two days; the day never lost; the hand destroyed to get it out of the band).
- **The door.** — SPENT: Ch. 41 "The Second" (the sixty-third morning; the princess stands up; out of a camp of fifty unseen).
- **The party.** — SPENT: Ch. 42 "The Question" (the search party of twelve fought and killed; one kept and questioned).
- **The village.** — SPENT: Ch. 43 "The Water" + Ch. 44 "The Doors" (DORESH; forty doors and not one opens; the iron off and the Art back after seventy days).
- **The one betrayer, and the company.** — SPENT: Ch. 45 "The Ground" + Ch. 46 "The Narrow" (Tarim bought, not stopped; nineteen down the fold and none back up).
- **The road, and the city.** — SPENT: Ch. 47 "The Crossing" + Ch. 48 "The Honest Men" (eleven days east; NALAR named; ISHARETH, held one bridge wide; the crew found).
- **The door, and the terms.** — SPENT: Ch. 49 "The Paper" (the fake-out and the hooded walk; the Art shown; the trade struck at one part in ten).
- **The raid.** — SPENT: Ch. 50 "The Reward" (the raid as a delivery; nobody killed; the chest out of the gate in the open).
- **The questioning.** — SPENT: Ch. 51 "The Ships" (the governor answers; QESHET TAKEN; the third concession refused; the crew part for Solvenna).
- **The joining.** — SPENT: Ch. 52 "The Work" (the council on the three roads; the princess rules; the terms in the crew's shape; BORREN named).
- **The first day inside.** — SPENT: Ch. 53 "The Round" (the leaving by water; the round of names; TAMAR and ADAH; five of the crew named).
- **The trade.** — SPENT: Ch. 54 "The Trade" (a couple of months compressed; the jobs on the page; the bridge; the stair, and nothing at the stream).
- **The job.** — SPENT: Ch. 55 "The Job" (the winter in a town where nobody asks; fourteen, marked by nobody; the hand; nine months; the tax-house coin told at the fire, nobody paying; the two tents — right or wrong, and hope).
- **The plan.** — SPENT: Ch. 56 "The Pieces" (the tax-house counted; the disguise, the sleeping herb, the painted iron; the Resonant danger said whole; the stick; the walk down).
- **The heist.** — SPENT: Ch. 57 "The Breath" (a Resonant-guarded imperial tax-house taken silent; the doors handed over; the iron on the officer's Art hand; six years of coin out).
- **The betrayal, and the end of the crew.** — SPENT: Ch. 58 "The Feast" + Ch. 59 "The Fire" (the one night's rest; the coalition on Ambros's letters; THIRO killed by the three; BORREN revealed an air Resonant and a master and spent to the last breath; Ambros the betrayer, killed by Borren; the warehouse man; **six out in two wagons with half the coin**). **The crew line is closed — the honest men are finished** (`../02-World-Bible/factions.md`).
- **The road to Ishareth.** — SPENT at Ch. 47; the pre-spend plan is in `archive/outline-archive.md`.
- **What each of these chapters actually did is `07-Story-Ledger/chapter-records.md`** — the one canonical per-chapter record. These pins are addresses, not summaries.
...
- **1 — THE DOOR, AND THE OPEN GROUND. FULLY SPENT** (Ch. 41–44): the door, the search party, the pursuit *slower and bigger*, ISHARETH spoken, and the near ground minted (the KHAROUN, DORESH). Nothing owed off this beat.
- **1b — THE PURSUIT IS DESTROYED, AND THE ROAD EAST IS THE ONLY ROAD. SPENT** (Ch. 45–46). **Still live:** of the fifty on that road twenty-one are left, and the page never says whether Kael turned east for the map or for the man.
- **2 — QESHET IS GONE. SPENT** (Ch. 51, learned at distance; Ch. 52, the reasoning that turns it into a road). Nothing owed off this beat.
...
- **4 — THE CREW (the main line). SPENT INTO ITS RUNNING STATE** (Ch. 48 first contact · Ch. 49 the trade · Ch. 51 the parting · Ch. 52 the joining · Ch. 53 the first day). **What the beat still owes:** the rest of thirteen months paid in work, with **three identities held the whole way** — from the crew and from everybody else (held through Ch. 55's nine months); the winter is spent (Ch. 55); **the job is DONE and the crew is DESTROYED (Ch. 56–59)** — the heist succeeded and the coalition wiped the crew out for it on Ambros's betrayal; **six survive** (the trio, Tirzah, the twins) and go on to Solvenna with half the coin; and the road itself, which no page names — *between Ishareth and Solvenna* is the whole of it, and the winter town is one more of its forgotten names. The jobs are on the page from Ch. 54, and the first was the crew's; the first with no client is Ch. 55's. The crew's page-state is `02-World-Bible/factions.md` §THE HONEST MEN and `03-Character-Bible/crew.md`.
- **5 — SOLVENNA, AND THE REUNION.** Book Two ends when the group is one again. Who arrives, and what it costs, is not yet written.
- **Unminted / undecided:** the capital's name (unnamed on every page to date) · whether the cover story accretes beyond *sister and cousin, Tamar and Adah* · the crew's route (upstream, then off the road, and no more than that on the page) · the jobs, and when the first one comes. **Camp life and the jobs are on the page** (Ch. 53–54). **The coalition country the border runs against is minted: NALAR** (Ch. 47); **the crew's leader is BORREN and the one rule is on the page** (Ch. 52).
