...
- **4 — THE CREW (the main line). SPENT INTO ITS RUNNING STATE** (Ch. 48 first contact · Ch. 49 the trade · Ch. 51 the parting · Ch. 52 the joining · Ch. 53 the first day). **What the beat still owes:** the rest of thirteen months paid in work, with **three identities held the whole way** — from the crew and from everybody else (held through Ch. 54's two months); the winter Borren priced; and the road itself, which no page names — *between Ishareth and Solvenna* is the whole of it. The jobs are on the page from Ch. 54, and the first was the crew's. The crew's page-state is `02-World-Bible/factions.md` §THE HONEST MEN and `03-Character-Bible/crew.md`.
