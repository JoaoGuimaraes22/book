# ARCHIVE — prompt-system.md as it stood at s66, verbatim

**Moved here whole (author, s66: *its very bloated, this and readme, and disorganized. fix both*)** when both governing files were consolidated to rules only. Every finding, count, reversal and run record of s47–s65 that the live file carried is below, exactly as it stood; the live `../prompt-system.md` keeps the rules those findings produced, and `../README.md` §The files says where the rest of the history is.
