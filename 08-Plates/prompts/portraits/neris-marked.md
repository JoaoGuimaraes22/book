...
THREE PIECES OF HER HAIR, AND ONLY THREE, ARE WHITE FROM THE ROOT
TO THE END — a hard cold white with no warmth and no yellow in it,
the white of a split stone. One of them is at the front of the hair
above the forehead, on the side of the head turned toward the
viewer; the other two are back in the mass on that same side,
separate from each other and clearly countable. Every other hair on
her head is dark brown and unchanged: no grey, no silver, no
lightening at the temples and no fourth white piece anywhere on her.
The three white pieces are white in colour and value only, and not
in edge: they bleed softly into the dark hair around them with no
hard ink outline anywhere along them, and they take none of the
sharpest step from light to dark, which stays inside the eye.
