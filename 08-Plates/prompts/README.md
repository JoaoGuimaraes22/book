...
`portraits/aurelian-14` · `portraits/elarine-14` · `portraits/neris` · `portraits/vask` · `portraits/severin` · `scene-tests/quartet-conversation` · `scene-tests/vask-kael-goat` (s37, author-written, first run) · `portraits/kael-4` (s36, first run, adopted)
