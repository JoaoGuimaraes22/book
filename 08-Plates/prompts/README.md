...
**NO ADOPTED IMAGE.** `plates/ch01-the-catch` · `ch01-room-of-true-things` · `ch01-telling-the-goat` · `ch01-talking-the-goat-down` · `ch02-done` · `ch08-seeing-about-the-goat` · `ch12-the-hole-through-the-tree` (ran; rejected) · `ch16-the-ear-on-the-brick` (run 1 not adopted; run 2 pending) · `portraits/kael-9-still` (not run).
