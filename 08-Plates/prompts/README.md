...
`portraits/kael-9` (s40, author-revised, first run) · `portraits/aurelian-14` · `portraits/elarine-14` · `portraits/neris` · `portraits/vask` · `portraits/severin` · `scene-tests/quartet-conversation` · `portraits/kael-4` (s36, first run, adopted)
