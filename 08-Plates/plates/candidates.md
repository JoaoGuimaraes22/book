...
3. **The law on the table.** — *built on the `ch12.md` sheet, unrun; taken as the chapter's second plate after candidate 2 was rejected.* The lamp, both parents, and *"You will not enter it."* His hands go flat on the boards because hers go flat when a thing matters. Three faces and a fire eating what it is given, and the answer arriving faster than any answer that house has ever given.
