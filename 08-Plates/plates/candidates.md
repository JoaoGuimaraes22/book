...
2. **The spots of colour.** — **COMPOSED (s45), not yet run: sheet `ch13.md`**, narrowed to the close on her and staged against `ch12-furniture` — same hall, same laughter, the opposite face. The hall joke: Oss up on the bench-end doing her flat voice, the crop of laughter, and at the far table Elarine straight as a mast with spots of colour high on her cheeks. **This is one of only two chapters where that tell is legal** (`../canon-brief.md`: Ch. 13 and Ch. 17, nowhere else), and it is the better of the two because here she is being spent in public without having chosen it.
