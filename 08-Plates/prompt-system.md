...
**Scale.** A ratio to something in the frame, never an adjective — *very small* and *a toddler, not a boy of seven* both failed; the SCALE paragraph in `prompts/plates/book-one/ch01-vask-kael-goat.md` held (the child's head to the man's hip, the head a fifth of his height, the goat's shoulder at his chest). The two terms must sit where the frame can compare them.
