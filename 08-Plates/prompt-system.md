...
**Gaze and expression.** Say where each pair of eyes goes. *Level* is a direction, not a temperament. Point at the mouth (*mouth open mid-word*), not the abstraction. State a contradiction as one — *the body is deferential and the attention is not.* *Not smiling — just not braced* got warmth without breaking character. Eye contact between two figures is named as the subject, on its own, in caps:
